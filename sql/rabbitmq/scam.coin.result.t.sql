...
CREATE OR REPLACE TABLE rmq.json_event (
...
CREATE OR REPLACE TABLE rmq.json_event_ (
        timestamp DateTime64(3),
        id UInt32,
        routingKey String,
        body String,
...
SETTINGS
    ...
    rabbitmq_routing_key_list = 'ms.scam-coin.IsHoneypotCoin',
...
CREATE MATERIALIZED VIEW rmq.json_event_view
TO rmq.event AS
SELECT
    now() as timestamp,
    id AS id,
